...
$if(draft)$ 
\renewcommand{\confidential}{DRAFT/CONFIDENTIAL}
$endif$
...
$if(sponsor)$
\renewcommand{\sponsor}{Sponsor: $sponsor$}
$endif$

\newcommand{\projectnumber}{Project Number:  }
$if(projectnumber)$
\renewcommand{\projectnumber}{Project Number: $projectnumber$}
$endif$

\rhead{\projectnumber  \\  \sponsor }
\lhead{Metrum Research Group\\\confidential}
%\rfoot{Right bottom}
